...
updatePrompt();
setInterval(updatePrompt,24*60*60*1000); // new prompt daily
...
if("Notification" in window){
  ...
  setTimeout(()=>{ new Notification("CalmSpace Reminder","Time to log your mood today 🌿"); },5000); // demo notification 5s after load
}